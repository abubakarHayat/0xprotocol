  ...
  async function sign() {
    try {
      ...
      const order = new LimitOrder({
        makerToken: "0x02649C1Ff4296038De4b9bA8F491b42b940A8252", //"0xc03ce38bc55836a4ef61ab570253cd7bfff3af44", // 0x32de... is a test ERC20 token; you can leverage the @0x/contract-addresses library for standard tokens (e.g., addresses.etherToken, addresses.zrxToken)
        takerToken: "0x02649C1Ff4296038De4b9bA8F491b42b940A8252", // Polygon USDC: 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174; Ropsten DAI: 0xad6d458402f60fd3bd25163575031acdce07538d
        makerAmount: (+sellAmount * 1000000000000000000).toString(), // 1 LONG; 0.01 for ERC20 tokens with 18 decimals
        takerAmount: (+buyAmount * 1000000000000000000).toString(), // 0.5 WAGMI18; <- Polygon USDC with 6 decimals (1000 = 0.001); Ropsten DAI with 18 decimals (50000000000000000 = 0.05)
        maker: maker,
        sender: NULL_ADDRESS,
